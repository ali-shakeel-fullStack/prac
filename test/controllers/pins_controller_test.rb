...
class PinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pin" do
    assert_difference("Pin.count") do
      post pins_url, params: { pin: { content: @pin.content, name: @pin.name, title: @pin.title } }
    end
  ...
  test "should update pin" do
    patch pin_url(@pin), params: { pin: { content: @pin.content, name: @pin.name, title: @pin.title } }
